...
public class maintest {
    ...
    public static void main(String[] args) {
        ...
        //
        //        User u = new User();
        //        u.setFirstName("saman");
        //        u.setLastName("text");
        //        u.setUsername("ucdocs");
        //        u.setPassword("ucdoc");
        //        u.setRole("CHIEFDOCTOR");
        //
        //
        //        User um = new User();
        //        um.setFirstName("khan");
        //        um.setLastName("talk");
        //        um.setUsername("udocs");
        //        um.setPassword("udoc");
        //        um.setRole("DOCTOR");
        //
        //
        //        User uma = new User();
        //        uma.setFirstName("ted");
        //        uma.setLastName("bundy");
        //        uma.setUsername("mohs");
        //        uma.setPassword("moh");
        //        uma.setRole("MOHADMIN");
        //
        //        new UserDAOImpl().saveUser( um);
        //        new UserDAOImpl().saveUser( uma);
        //        new UserDAOImpl().saveUser( u);

        //        h.setChiefDoctor( u);
        Session session = HibernateUtil.getSessionFactory().openSession();
        Transaction tx = session.beginTransaction();
        Hospital hospital = new HospitalDAOImpl().getHospitalById("402888f27a9a8442017a9a8446f40003");
        try {
